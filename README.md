...
> **Note**
> The likelihood is high that the repo you are working on is either a Stack or Stacks itself. In both cases, you will be exposed to a mesh-up of technologies, like [Vue][vue], [Vite][vite], [Tauri][tauri], and [Bun][bun].
...
An understanding of the framework architecture and design will help if you're looking to contribute long-term, or if you are working on a "more complex" PR. Browse the source and read our documentation to get a better sense of how it is structured. The documentation is thorough and can be used as your progressive guide as you learn more about Stacks.
...
All of the framework tests are stored within the `./.stacks/tests` project folder. When adding or updating functionality, please ensure it is covered through our Vitest test suite. Ensure so by running `buddy test`.
